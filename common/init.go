...
func InitEnv() {
	...
	CaptchaRateLimitEnable = GetEnvOrDefaultBool("CAPTCHA_RATE_LIMIT_ENABLE", true)
	CaptchaRateLimitNum = GetEnvOrDefault("CAPTCHA_RATE_LIMIT", 60)
	CaptchaRateLimitDuration = int64(GetEnvOrDefault("CAPTCHA_RATE_LIMIT_DURATION", 60))
