...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/captcha", middleware.CaptchaRateLimit(), controller.GetImageCaptcha)
		apiRouter.POST("/captcha/verify", middleware.CaptchaRateLimit(), anonymousRequestBodyLimit, controller.VerifyImageCaptcha)
		...
		subscriptionAdminRoute.Use(middleware.AdminAuth())
		{
			...
			subscriptionAdminRoute.POST("/user_subscriptions/:id/activate", controller.AdminActivateUserSubscription)
