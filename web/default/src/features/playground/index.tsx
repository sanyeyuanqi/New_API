  ...
  return (
    <div className='relative flex size-full overflow-hidden'>
      ...
      <div className='relative flex min-w-0 flex-1 flex-col overflow-hidden'>
        ...
        <div
          className={cn(
            'absolute left-1/2 z-10 mx-auto w-full max-w-4xl -translate-x-1/2 px-3 pb-3 transition-[top,bottom] duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] md:px-0 md:pb-0',
            messages.length === 0
              ? 'top-[calc(46%-150px)]'
              : 'bottom-4'
          )}
