...
export const STATIC_I18N_KEYS = [
  ...
  '5-hour next reset',
  'Enable 5-hour quota',
  'Only available when reset cycle is weekly',
  'Cannot exceed weekly quota',
  'Five-hour quota can only be enabled for weekly reset',
  'Weekly quota must be greater than zero',
  'Five-hour quota must be greater than zero',
  'Five-hour quota cannot exceed weekly quota',
